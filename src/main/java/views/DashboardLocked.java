...
public class DashboardLocked extends javax.swing.JFrame {

    public DashboardLocked() {
        initComponents();
        InitStyles();
        SetDate();
        InitContent();
...
appName.setForeground(color);
    ...
    // Deshabilita el botón btnIniciarSesion
    btnIniciarSesion.setEnabled(false);

    // Oculta el botón btnIniciarSesion (opcional)
    btnIniciarSesion.setVisible(false);

    // Muestra el nuevo panel winIniciarSesion
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            DashboardLocked dashboard = new DashboardLocked();
